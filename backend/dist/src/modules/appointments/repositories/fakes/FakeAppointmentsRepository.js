...
var FakeAppointmentsRepository = /** @class */ (function () {
    ...
    FakeAppointmentsRepository.prototype.findAllInDayFromProvider = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                findAppointment = this.appointments.filter(function (appointment) {
    ...
    FakeAppointmentsRepository.prototype.findAllInMonthFromProvider = function (_a) {
        var providerId = _a.providerId, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var findAppointment;
            return __generator(this, function (_b) {
                findAppointment = this.appointments.filter(function (appointment) {
    ...
    FakeAppointmentsRepository.prototype.create = function (_a) {
        var providerId = _a.providerId, date = _a.date, userId = _a.userId;
        return __awaiter(this, void 0, void 0, function () {
            var appointment;
            return __generator(this, function (_b) {
                appointment = new Appointment_1.default();
                Object.assign(appointment, { id: uuidv4_1.uuid(), date: date, providerId: providerId, userId: userId });
