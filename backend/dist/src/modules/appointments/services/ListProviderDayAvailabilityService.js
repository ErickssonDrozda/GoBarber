...
var ListProviderDayAvailabilityService = /** @class */ (function () {
    ...
    ListProviderDayAvailabilityService.prototype.execute = function (_a) {
        var providerId = _a.providerId, day = _a.day, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsInDay, hourStart, eachHourArray, currentDate, availability;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointmentsRepository.findAllInDayFromProvider({
                            providerId: providerId, day: day, month: month, year: year
                        })];
                    case 1:
                        appointmentsInDay = _b.sent();
                        hourStart = 8;
                        ...
                        availability = eachHourArray.map(function (hour) {
                            var hasAppointmentInHours = appointmentsInDay.find(function (appointment) {
                                return date_fns_1.getHours(appointment.date) === hour;
                            });
                            var appointmentDateToCompare = new Date(year, month - 1, day, hour);
                            return {
                                hour: hour,
                                available: !hasAppointmentInHours && date_fns_1.isAfter(appointmentDateToCompare, currentDate)
                            };
                        });
