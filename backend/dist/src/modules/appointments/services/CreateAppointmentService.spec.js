...
describe('CreateAppointment', function () {
    ...
    it("Should to create a new appointment", function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createAppointment.execute({ date: new Date(2020, 5, 11, 13), userId: 'user', providerId: '12255514' })];
                case 1:
                    appointment = _a.sent();
    ...
    it("Should not be able to create a new appointment on the same date", function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    appointmentDate = new Date(2020, 5, 10, 13);
                    return [4 /*yield*/, createAppointment.execute({ date: appointmentDate, userId: 'user', providerId: '12255514' })];
                case 1:
                    _a.sent();
    ...
    it('Should not be able to create appointment on a past date', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('Should not be able to create appointment with same user as provider', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('Should not be able to create appointment before 8am and after 5pm', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
