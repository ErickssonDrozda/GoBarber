...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        var userId = _a.userId, name = _a.name, email = _a.email, password = _a.password, oldPassword = _a.oldPassword;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (password && !oldPassword) {
                            throw new AppError_1.default("You need to inform the old password to set the new password");
                        }
